...
# 1. Update LiveEmergencyChat.jsx
chat_file = "src/components/LiveEmergencyChat.jsx"

new_chat_code = """import React, { useState, useEffect, useRef } from 'react';
...
with open(chat_file, "w", encoding="utf-8") as f:
    f.write(new_chat_code)


# 2. Update LiveEmergencyChat invocation in CitizenDashboard.jsx
cit_file = "src/views/CitizenDashboard.jsx"
with open(cit_file, "r", encoding="utf-8") as f:
    c_content = f.read()

old_invocation = """          {/* Real-time Socket Chat Section */}
...
new_invocation = """          {/* Real-time Socket Chat Section */}
          <div id="socket-chat-section" className="scroll-mt-20">
            {incidentData?.incident_id && (
              <LiveEmergencyChat 
                incidentId={incidentData.incident_id}
...
c_content = c_content.replace(old_invocation, new_invocation)
with open(cit_file, "w", encoding="utf-8") as f:
    f.write(c_content)

print("Dynamic unit chat routing patched in LiveEmergencyChat.jsx and CitizenDashboard.jsx")
